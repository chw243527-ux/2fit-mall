...
class _GroupOrderFormScreenState extends State<GroupOrderFormScreen>
  ...
  // 0: 색상만, 1: 단체명+색상, 2: 디자인+단체명+색상, 3: 디자인+색상+단체명+이름(후면)
  bool get _hasColorChange => _printType == 0 || _printType == 1 || _printType == 2 || _printType == 3;
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Container(
          ...
          child: Row(children: [
            ...
            const SizedBox(width: 8),
            Text('재봉방법: ', style: TextStyle(fontSize: 11, color: Colors.teal.shade700, fontWeight: FontWeight.w600)),
        ...
        Container(
          ...
          child: Row(children: [
            ...
            Column(mainAxisSize: MainAxisSize.min, children: [
              if (p.gender == null)
                Text('필수*', style: TextStyle(fontSize: 9, color: Colors.red.shade600, fontWeight: FontWeight.w700)),
