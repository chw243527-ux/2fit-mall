...
class ProductModel {
  ...
  /// 일부 상품 필드만 변경한 새 ProductModel 반환
  ProductModel copyWith({
    ...
    String? editorialLabel,
    String? editorialTitle,
    String? editorialAccent,
    String? editorialSubtitle,
    String? editorialMaterialKey,
    String? editorialMaterialText,
    String? editorialSource,
    bool? editorialLocked,
  }) {
    return ProductModel(
      id: id ?? this.id,
      name: name ?? this.name,
      ...
      soldOutSizes: soldOutSizes ?? this.soldOutSizes,
      ...
      editorialLabel: editorialLabel ?? this.editorialLabel,
      editorialTitle: editorialTitle ?? this.editorialTitle,
