...
class _InlineColorChartState extends State<InlineColorChart>
  ...
  // 색상 조절 슬라이더용
  Color _baseColor = const Color(0xFF1565C0);
  double _hue = 210, _sat = 0.85, _lit = 0.40;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // ── HSL 조절 패널 (TabBarView 밖 - 레이아웃 안전) ──
          if (_showAdjust) _buildHslPanel(),
        ],
      ),
    );
  }
  ...
  Widget _buildHslPanel() {
    final adjColor = HSLColor.fromAHSL(
